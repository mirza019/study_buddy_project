...
Format:
1. Start with a peaceful Islamic greeting in User's Language based on user's {country} language For Example, if user is from English. Speaking country, say“Peace Be Upon You, Dear {name} ”, if user is from Iran say "Salam {name} ".
